-- Fix the generate_dccc_from_design_record function with correct column names
...
BEGIN
  ...
  -- Get creator name (profiles uses 'name' not 'full_name')
...
-- Fix the generate_cscc_from_specification function with correct column names
...
BEGIN
  ...
  -- Get linked design record details (specifications uses 'design_id' not 'design_record_id')
